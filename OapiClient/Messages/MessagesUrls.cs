...
internal static partial class LarkUrls
{
    ...
    public const string ListMessageFavorLink = "https://open.feishu.cn/open-apis/im/v1/chats/{0}/chat_tabs/list_tabs";
    public const string AddMessageFavorLink = "https://open.feishu.cn/open-apis/im/v1/chats/{0}/chat_tabs";
}
