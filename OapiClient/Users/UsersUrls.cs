...
internal static partial class LarkUrls
{
    ...
    public const string SearchCompanyDepartments = "https://open.feishu.cn/open-apis/corehr/v2/departments/search";
    public const string GetCompanyDepartments = "https://open.feishu.cn/open-apis/corehr/v2/departments/batch_get";
    public const string GetCompanyDepartmentsParent = "https://open.feishu.cn/open-apis/corehr/v2/departments/parents";
